pipeline
{
    ...
    stages{
        ...
        stage("Deploy to EC2")
        {
            ...
            {
                sshagent(['EC2FileID']) {
                    sh "C:/Program Files/Git/bin/ssh -o StrictHostKeyChecking=no ec2-user@ec2-52-7-235-115.compute-1.amazonaws.com docker run -p 8080:8080 -d --name petclinic mccaffertydocker/petclinic:2.0.0"
                }
